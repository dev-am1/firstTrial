<template>
  <div class="carousel-3d-container" :style="{height: this.slideHeight+100 + 'px'}">
    <div class="carousel-3d-slider" :style="{width: this.slideWidth + 'px', height: this.slideHeight + 'px'}">
      <slot></slot>
    </div>
            <div :class="classes" >
        <button @click="goNext"><img src="../../../assets/icons/right.png"></button>
        <slot name="bullet"></slot>
        <button @click="goPrev"><img src="../../../assets/icons/left.png"></button>
    </div>
  </div>
</template>
