<template>
  <div class="container items-center justify-around flex wrap" id="menu1">
      <div class="flex flex-col w-2/4">
       <text-slider :fields="3" :data="datas" ></text-slider>
      </div>
      <div class="flex">
        <div class="cube"></div>
      </div>
...
<script>
import TextSlider from '../ui/TextSlider.vue';
export default {
  components:{
    TextSlider
  },
